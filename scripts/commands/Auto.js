module.exports.config = {
 ...
 const content = event.body ? event.body : '';
  ...
  const { ytdown, ndown, tikdown, twitterdown, fbdown } = require("nayan-media-downloader")
  let msg = "";
  ...
  if (body.startsWith("https://fb.watch/") || body.startsWith("https://www.facebook.com")) {
    const fbApiResponse = await fbdown(body);
    console.log(fbApiResponse)
    const fbVideoUrl = fbApiResponse.media.hd;
